function minDist = SimulationDist(q, Walls, Obstacles)
% parametri:
...
minDist_Walls = GetDistToClosestObject(q,Walls);
minDist_Obstacles = GetDistToClosestObject(q,Obstacles);

minDist = min(minDist_Walls,minDist_Obstacles);
...
if(minDist>MAX_DOSEG_SENZORJA)
    minDist=MAX_DOSEG_SENZORJA;
end
...
function minRazdalja = GetDistToClosestObject(q,Enviroment)
