...
hd = plot(1250,900,'b-','LineWidth',1,'erasemode','xor');   % current node area
for j = 1:length(Nodes(i).Neighbours)
    hj(j) = plot([0 0],[0 1],'b-','LineWidth',2,'erasemode','xor'); % current node connections
end
